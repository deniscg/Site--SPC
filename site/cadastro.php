...
if (isset($_POST['login'])){
   ...
   $sql_busca2 = "SELECT * FROM Login WHERE email = '$email'";
   ...
   if (!isset($ac)){
	  ...
	  $sql_inclu = "INSERT INTO Login(usuario, senha, sessao,email) VALUES
	                ('$login', '$senha', '$sessao' ,'$email')";
	  ...
	  $topico = "Cadastro $nome_site";
	        ...
	        //$destino = $emaild;
    //Sera o email -  $destino = "denispereiracg@hotmail.com";
   // Emaild � o e-mail da pessoa que vai receber a mensagem
    $remail = "canalwebmail@canalwebcg.com.br";
    // Remail � o e-mail do qual voc� vai enviar todos os e-mails para clientes
   //Sera o topico -  $assunto = "Email de Teste";
      // Aqui vem o assunto da mensagem
   // $mensagem = "Este e-mail � um teste de envio apenas para ver que funciona!";
    ...
    $headers .= "Return-Path: <$remail>\n";
	 ...
	 //- $headers = "MIME-Version: 1.0\r\n";
     //- $headers .= "Content-type: text/html; charset=iso-8859-1\r\n";
	 //- $headers .= "From: canalwebmail@canalwebcg.com.br>\r\n";
